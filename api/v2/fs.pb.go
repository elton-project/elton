...
type ListCommitsRequest struct {
	...
	Next string `protobuf:"bytes,2,opt,name=next,proto3" json:"next,omitempty"`
	// コミットの一覧を取得するvolume。
	Id                   *VolumeID `protobuf:"bytes,3,opt,name=id,proto3" json:"id,omitempty"`
	XXX_NoUnkeyedLiteral struct{}  `json:"-"`
	XXX_unrecognized     []byte    `json:"-"`
	XXX_sizecache        int32     `json:"-"`
}
...
func (m *ListCommitsRequest) GetId() *VolumeID {
	if m != nil {
		return m.Id
	}
	return nil
...
func (m *GetCommitRequest) GetId() *CommitID {
	if m != nil {
		return m.Id
	}
	return nil
...
func (m *GetCommitResponse) GetId() *CommitID {
	if m != nil {
		return m.Id
	}
	return nil
...
func (m *GetCommitResponse) GetInfo() *CommitInfo {
	if m != nil {
		return m.Info
	}
	return nil
...
type CommitRequest struct {
	...
	BaseCommitId         *CommitID   `protobuf:"bytes,5,opt,name=base_commit_id,json=baseCommitId,proto3" json:"base_commit_id,omitempty"`
	XXX_NoUnkeyedLiteral struct{}    `json:"-"`
	XXX_unrecognized     []byte      `json:"-"`
	XXX_sizecache        int32       `json:"-"`
}
...
func (m *CommitRequest) GetBaseCommitId() *CommitID {
	if m != nil {
		return m.BaseCommitId
	}
	return nil
}
...
func init() {
	...
	proto.RegisterType((*GetCommitRequest)(nil), "elton.v2.GetCommitRequest")
	proto.RegisterType((*GetCommitResponse)(nil), "elton.v2.GetCommitResponse")
...
var fileDescriptor_e604833c2b457e38 = []byte{
	...
	,
}
...
func (c *commitServiceClient) GetCommit(ctx context.Context, in *GetCommitRequest, opts ...grpc.CallOption) (*GetCommitResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/elton.v2.CommitService/GetCommit", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (*UnimplementedCommitServiceServer) GetCommit(ctx context.Context, req *GetCommitRequest) (*GetCommitResponse, error) {
...
func _CommitService_GetCommit_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/elton.v2.CommitService/GetCommit",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
